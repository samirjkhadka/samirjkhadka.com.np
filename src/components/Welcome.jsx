...
const Welcome = () => {
  ...
  return (
    ...
    <section id="welcome" className="text-white">
      <p ref={subtitleRef} className="">
        {renderText(
          " I am Samir J Khadka! Welcome to my",
      ...
      <div className="small-screen">
        <p>
          This portfolio is designed for desktop and tablet devices. For mobile
          devices, please use the menu bar.
        </p>
      </div>
    </section>
  );
